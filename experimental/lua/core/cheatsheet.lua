...
local SECTIONS = {
  {
    "PROJECT ACTIONS",
    {
      ...
      { "<Tab> / <S-Tab>  (pane)", "next / previous: task output, program output, REPL" },
    },
  },
  {
    "DEBUGGING  (<Leader>d…)",
  ...
  },
  {
    "FINDING THINGS",
    {
      ...
      { "<Leader>sk", "keymaps — the complete live list, not this page" },
  ...
  },
  {
    "TOGGLES  (<Leader>u…)",
    {
      ...
      { "un / uC", "dismiss notifications / pick a colourscheme" },
    },
  },
  {
