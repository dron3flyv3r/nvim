...
local STATIC = {
  ...
  },
  {
    "REVIEWING CHANGES",
    {
      ...
      { "?", "show or hide the key strip along the bottom" },
  ...
  },
  {
    ...
    {
      { "<Leader>gd", "open the conflicts as OURS / RESULT / THEIRS" },
      { "n / N", "next / previous conflict" },
      { "H / L", "take ours, the left pane / theirs, the right pane" },
      { "B / X", "take both sides / drop what is left of the conflict" },
      { "gH / gL / gB", "the same three for the whole file" },
      { "<CR>", "take this line, or the selected lines, from any pane" },
      { "]r / [r", "walk what you resolved, with what you took" },
      { "<Tab>", "the next file that still has conflicts" },
      { "<Leader>cb", "take or show BASE, the common ancestor" },
      { "q", "save and stage, save and finish the merge, or discard" },
      { "<Leader>gg / gm", "Neogit status / merge and continue" },
    },
  },
  {
    "READING ERRORS & DOCS",
