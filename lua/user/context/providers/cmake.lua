...
function M.detect(ctx)
  if not vim.tbl_contains({ "c", "cpp", "objc", "objcpp", "cuda", "proto", "cmake" }, ctx.filetype) then
    return false
  end
...
function M.actions()
  return {
    {
      id = "cmake.run",
      label = "Run target containing current file",
      category = "Run",
      run = command "CMakeRunCurrentFile",
    },
    { id = "cmake.test", label = "Run CTest", category = "Run", run = command "CMakeRunTest" },
    {
      id = "cmake.debug",
      label = "Debug target containing current file",
      category = "Run",
      run = command "CMakeDebugCurrentFile",
    },
    { id = "cmake.build", label = "Build selected target", category = "Build", run = command "CMakeBuild" },
    ...
    {
      id = "cmake.build_target",
      label = "Select build target",
      category = "Project",
      run = command "CMakeSelectBuildTarget",
    },
    {
      id = "cmake.launch_target",
      label = "Select launch target",
      category = "Project",
      run = command "CMakeSelectLaunchTarget",
    },
    {
      id = "cmake.build_type",
      label = "Select build type",
      category = "Project",
      run = command "CMakeSelectBuildType",
    },
    ...
    {
      id = "cmake.stop",
      label = "Stop CMake execution",
      category = "Maintenance",
      run = command "CMakeStopExecutor | CMakeStopRunner",
    },
